...
use hopsworks_core::feature_store::{
    embedding::EmbeddingIndex, query::Query, FeatureGroup, FeatureStore, FeatureView,
};
use hopsworks_core::get_hopsworks_runtime;

#[cfg(feature = "blocking")]
pub fn get_feature_group_blocking(
    fs: &FeatureStore,
    name: &str,
    version: Option<i32>,
    multithreaded: bool,
...
#[cfg(feature = "blocking")]
pub fn get_feature_view_blocking(
    fs: &FeatureStore,
    name: &str,
    version: Option<i32>,
    multithreaded: bool,
...
#[cfg(feature = "blocking")]
pub fn create_feature_view_blocking(
    fs: &FeatureStore,
    name: &str,
    version: i32,
    query: Query,
